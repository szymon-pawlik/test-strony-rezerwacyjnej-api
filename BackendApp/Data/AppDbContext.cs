...
namespace BackendApp.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var userId2 = Guid.Parse("b9c5d3b0-3d1c-4c6f-8e4d-1a2b3c4d5e6f");
            ...
            modelBuilder.Entity<Apartment>().HasData(
                ...
                new Apartment(
                    apartmentId2,
                    "Sunny Loft with River View",
                    "Spacious and bright loft with a beautiful view of the river.",
                    "Brooklyn, NY",
                    2,
                    2,
                    new List<string> { "WiFi", "Air Conditioning", "Balcony", "Gym Access" },
                    true,
                    250m
                ),
                new Apartment(
                    ...
                    "A peaceful cottage perfect for a weekend getaway.",
                    "Lake Placid, NY",
                    3,
                    1,
                    new List<string> { "WiFi", "Fireplace", "Lake Access", "Pet-friendly" },
                    false,
                    180m
                )
            );
            ...
            modelBuilder.Entity<User>().HasData(
                new User(userId1, "Jan Kowalski", "jan.kowalski@example.com", janPasswordHash),
                new User(userId2, "Anna Nowak", "anna.nowak@example.com", annaPasswordHash)
            );
            ...
            modelBuilder.Entity<Booking>().HasData(
                new Booking(
                    ...
                    apartmentId1,
                    userId1,
                    new DateTime(2025, 7, 10, 0, 0, 0, DateTimeKind.Utc),
                ...
                new Booking(
                    ...
                    new DateTime(2025, 8, 7, 0, 0, 0, DateTimeKind.Utc),
                    1500.0,
                    baseDate.AddDays(-15)
                ),
                new Booking(
                    ...
                    apartmentId1,
                    userId2,
                    new DateTime(2025, 9, 5, 0, 0, 0, DateTimeKind.Utc),
                    new DateTime(2025, 9, 10, 0, 0, 0, DateTimeKind.Utc),
                    600.0,
                    baseDate.AddDays(-5)
                )
            );
            ...
            modelBuilder.Entity<Review>().HasData(
                new Review(
                    ...
                    userId1,
                    5,
                    "Fantastic studio, great location and very clean. Highly recommended!",
                    baseDate.AddDays(-25)
                ),
                new Review(
                    reviewId2,
                    ...
                    userId2,
                    4,
                    "Loved the view and the space. The gym was a nice bonus. A bit noisy at times.",
                    baseDate.AddDays(-10)
                ),
                new Review(
                    reviewId3,
                    ...
                    userId2,
                    4,
                    "Good value for money, perfect for a short stay.",
                    baseDate.AddDays(-2)
                )
            );
        }
