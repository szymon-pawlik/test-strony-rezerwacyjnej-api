...
namespace BackendApp.Migrations
{
    ...
    [Migration("20250522193212_InitialSchemaAfterReset")]
            ...
            modelBuilder.Entity("BackendApp.Models.Apartment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cbacf7fe-8e06-4216-b187-1d9dfde24f47"),
                        ...
                        new
                        {
                            Id = new Guid("ba1fcefa-5969-49ba-99f4-65e917ed1ca4"),
                        ...
                        new
                        {
                            Id = new Guid("957d6a4a-e58e-43b4-88d1-873faaa333d2"),
                        ...
                        new
                        {
                            Id = new Guid("084e8116-e3a9-4161-a04e-d002816a5d86"),
                        ...
                        new
                        {
                            Id = new Guid("1dbaa489-85ec-4db5-8ccb-37504e4dea31"),
                        ...
                        new
                        {
                            Id = new Guid("a4f2f38a-0d40-4ef3-8485-3f09ad6ffee2"),
                        ...
                        new
                        {
                            Id = new Guid("8049fe47-d3a4-4a08-853f-fe440915eef4"),
                        ...
                        new
                        {
                            Id = new Guid("8917540c-c554-41fc-8989-ba4245289e08"),
                        ...
                        new
                        {
                            Id = new Guid("d0c6cb19-d9b8-4cde-8e59-43570c482f57"),
                        ...
                        new
                        {
                            Id = new Guid("834c08b7-cca5-41e5-b046-08530394a233"),
            ...
            modelBuilder.Entity("BackendApp.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d17f9a50-41c8-4402-ac75-2d40086128b3"),
                            ApartmentId = new Guid("cbacf7fe-8e06-4216-b187-1d9dfde24f47"),
                        ...
                        new
                        {
                            Id = new Guid("807230cd-9bfd-4d30-9b7d-73a94e5dd444"),
                            ApartmentId = new Guid("ba1fcefa-5969-49ba-99f4-65e917ed1ca4"),
                        ...
                        new
                        {
                            Id = new Guid("455f88a2-b36e-4eae-8f23-9c5acc2607a4"),
                            ApartmentId = new Guid("957d6a4a-e58e-43b4-88d1-873faaa333d2"),
                        ...
                        new
                        {
                            Id = new Guid("68543fb0-1de9-4dac-9938-6a0de311009b"),
                            ApartmentId = new Guid("cbacf7fe-8e06-4216-b187-1d9dfde24f47"),
            ...
            modelBuilder.Entity("BackendApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("941e99ed-9fc3-4a60-8f64-f2e41b098d1e"),
                            ApartmentId = new Guid("cbacf7fe-8e06-4216-b187-1d9dfde24f47"),
                        ...
                        new
                        {
                            Id = new Guid("098ff1a7-3231-4a55-8b75-acc6e53222a1"),
                            ApartmentId = new Guid("ba1fcefa-5969-49ba-99f4-65e917ed1ca4"),
                        ...
                        new
                        {
                            Id = new Guid("7456eec9-a798-4f83-9561-6717ff348448"),
                            ApartmentId = new Guid("cbacf7fe-8e06-4216-b187-1d9dfde24f47"),
                        ...
                        new
                        {
                            Id = new Guid("6fa712c9-9bf6-4561-9e27-e0adb5e8778c"),
                            ApartmentId = new Guid("957d6a4a-e58e-43b4-88d1-873faaa333d2"),
